            ...
            switch (name) {
                ...
                case "hr_cyber_about": {
                    return textContent({
                        name: SERVER_NAME,
                        version: pkgVersion,
                        description: "BSI (CERT.hr (Nacionalni CERT)) MCP server. Provides access to BSI technical guidelines, IT-Grundschutz building blocks, BSI Standards, and security advisories.",
