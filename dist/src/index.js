...
const TOOLS = [
    {
        ...
        description: "Full-text search across CERT.hr guidelines and technical standards. Covers national cybersecurity recommendations, NIS2 implementation guidance, ISMS standards, and critical infrastructure protection requirements for Croatia. Returns matching documents with reference, title, series, and summary.",
        inputSchema: {
            type: "object",
            properties: {
                query: {
    ...
    },
    {
        ...
        description: "Get a specific CERT.hr guidance document by reference (e.g., 'CERT.hr-GUIDE-2024-01', 'CERT.hr-REC-2023-02').",
        inputSchema: {
            type: "object",
            properties: {
                reference: {
    ...
    },
    {
        ...
        description: "Search CERT.hr security advisories and alerts. Returns advisories with severity, affected products, and CVE references where available.",
        inputSchema: {
            type: "object",
            properties: {
                query: {
    ...
    },
    {
        ...
        description: "List all CERT.hr frameworks and standard series covered in this MCP, including National Cybersecurity Strategy, NIS2 implementation, and ISMS guidance for Croatia.",
        inputSchema: {
            type: "object",
            properties: {},
            required: [],
        ...
        switch (name) {
            ...
            case "hr_cyber_about": {
                return textContent({
                    name: SERVER_NAME,
                    version: pkgVersion,
                    description: "CERT.hr (Nacionalni CERT — Croatian National CERT) MCP server. Provides access to CERT.hr guidelines, technical standards, NIS2 implementation guidance, and security advisories for Croatia.",
